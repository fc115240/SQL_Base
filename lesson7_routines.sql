...
--
-- Dumping events for database 'lesson7'
--

--
-- Dumping routines for database 'lesson7'
--
/*!50003 DROP FUNCTION IF EXISTS `set_like` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `set_like`(uid INT, eid INT) RETURNS tinyint(1)
    DETERMINISTIC
BEGIN
DECLARE x INT;
